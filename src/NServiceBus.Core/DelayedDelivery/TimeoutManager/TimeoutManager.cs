namespace NServiceBus.Features
{
    ...
    public class TimeoutManager : Feature
    {
        ...
        {
            var satelliteAddress = CreateSatelliteInputQueueAddress(context, "TimeoutsDispatcher");
        ...
        {
            var satelliteAddress = CreateSatelliteInputQueueAddress(context, "Timeouts");
        ...
        static string CreateSatelliteInputQueueAddress(FeatureConfigurationContext context, string queueQualifier)
        {
            var instanceName = context.Settings.EndpointInstanceName();
            var satelliteLogicalAddress = new LogicalAddress(instanceName, queueQualifier);
            var inputQueueAddress = context.Settings.GetTransportAddress(satelliteLogicalAddress);
